...
class minMoves {
    ...
    using board = std::array<std::array<size_t, boardSize>, boardSize>;
    using trackingMoves = std::stack<positionAndSteps>;
    ...
    void mark(const position &toMark, const size_t steps) {
        playground[toMark.first][toMark.second] = steps;
    }
    ...
    const positionAndSteps& backTracking(const positionAndSteps& currentPos ,const positionAndSteps& startPos )const{
